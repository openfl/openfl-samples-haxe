	...
	private function renderOpenGL(event:RenderEvent):Void
	{
		...
		if (glBuffer == null)
		{
			var data:Array<Float> = [
				...
				bitmapData.width, bitmapData.height, 0, 1, 1, 0, bitmapData.height, 0, 0, 1, bitmapData.width, 0, 0, 1, 0, 0, 0, 0, 0, 0
		...
		gl.vertexAttribPointer(glShader.data.openfl_TextureCoord.index, 2, RenderingContext.FLOAT, false, 5 * Float32Array.BYTES_PER_ELEMENT,
